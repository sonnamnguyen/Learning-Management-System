...
@Service
public class CJudgementService implements ExecutionBasedLanguage {
    private final String BASE_DIR = "src/main/java/com/example/code_judgement/c_judge/c/";
    ...
    public CompilationResult compileCode(String userCode) {
        ...
        String fileName = "program_" + randomId + ".c";
        ...
        try {
            ...
            ProcessBuilder compileBuilder = new ProcessBuilder("gcc", sourceFile.getAbsolutePath(), "-o", executableFile.getAbsolutePath());
